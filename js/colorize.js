...
(function () {
  var WIZARD_COATS = ['rgb(101, 137, 164)', 'rgb(241, 43, 107)', 'rgb(146, 100, 161)',
  ...
  colorize(wizardCoat, WIZARD_COATS, inputCoat);
  colorize(wizardEyes, WIZARD_EYES, inputEyes);
  colorize(wizardFireball, WIZARD_FIREBALLS, inputFireball);
